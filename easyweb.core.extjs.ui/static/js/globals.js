...
__COOKIE_AUTH_TOKEN__ = "easyweb_at";
__COOKIE_LOGIN_NAME__ = "easyweb_ln";
__COOKIE_REMEMBER_USER__ = "easyweb_ru";
__COOKIE_SESSION_CLIENT_MNDNO__ = "easyweb_scmno";
__COOKIE_SESSION_CLIENT_ID__ = "easyweb_sci";
__COOKIE_SESSION_CLIENT_CD__ = "easyweb_scd";

__COOKIE_CURRENT_THEME__ = "easyweb_th";

__DEFAULT_THEME__ = "gray";
__CURRENT_THEME__ = null;
__DEFAULT_LANGUAGE__ = "zh";
...
__CmpId__ = {
    APP_VIEW_HOME: "easyweb-application-view-home",
    APP_VIEW_HEADER: "easyweb-application-view-header",
    APP_VIEW_FOOTER: "easyweb-application-view-footer",
    APP_VIEW_BODY: "easyweb-application-view-body"
