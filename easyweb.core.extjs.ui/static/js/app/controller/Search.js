 ...
 */
Ext.define('Easyweb.controller.Search', {
    extend: 'Ext.app.Controller',

    requires: [
        'Easyweb.ClassRegistry',
        'Easyweb.GuideSearch',
        'Easyweb.store.Search',
        'Easyweb.History'
    ],
    ...
    loadRecord: function(record) {
        Easyweb.History.navigate(record.get("url"));
    ...
    search: function(term) {
        ...
        if (Easyweb.GuideSearch.isEnabled()) {
            this.guideSearch(term);
        }
    },

    guideSearch: function(term) {
        Easyweb.GuideSearch.deferredSearch(term, function(guideResults) {
            this.basicSearch(term, guideResults);
        }, this, this.guideSearchDelay);
    },

    basicSearch: function(term, guideResults) {
        this.displayResults(Easyweb.ClassRegistry.search(term, guideResults));
    },
