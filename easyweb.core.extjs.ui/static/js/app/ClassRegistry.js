 ...
 *
 * Provides access to Easyweb.data.search.
 */
Ext.define("Easyweb.ClassRegistry", {
    singleton: true,
    ...
    canonicalName: function(name) {
        if (!this.altNames) {
            this.altNames = {};
            Ext.each(Easyweb.data.search, function(r) {
     ...
     * @return {Object[]} array of the matching items from Easyweb.search.data
    ...
    search: function(text, guides) {
        ...
        var searchData = Easyweb.data.search;
