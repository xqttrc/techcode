 ...
 */
Ext.define('Easyweb.view.examples.InlinePreview', {
    extend: 'Ext.Panel',
    requires: [
        'Easyweb.view.examples.Device'
    ],
    ...
    getHtml: function() {
        if (Easyweb.data.touchExamplesUi) {
            return Ext.create('Easyweb.view.examples.Device', {
                url: "eg-iframe.html",
                id: this.iframeId,
