 ...
 */
Ext.define('Easyweb.view.examples.Inline', {
    extend: 'Ext.Panel',
    alias: 'widget.inlineexample',
    requires: [
        'Easyweb.view.examples.InlineEditor',
        'Easyweb.view.examples.InlinePreview'
    ],
    ...
    /**
     * @cfg {Easyweb.view.examples.InlineToolbar} toolbar
    ...
    initComponent: function() {
        ...
        this.items = [
            this.editor = Ext.create('Easyweb.view.examples.InlineEditor', {
                cmpName: 'code',
                value: this.value,
                listeners: {
            ...
            this.preview = Ext.create('Easyweb.view.examples.InlinePreview', {
                cmpName: 'preview',
    ...
    updateHeight: function() {
        ...
        if (Easyweb.data.touchExamplesUi && previewHeight > 0) {
