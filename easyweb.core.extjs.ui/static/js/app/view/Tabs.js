...
Ext.define('Easyweb.view.Tabs', {
    ...
    requires: [
        'Easyweb.History',
        'Easyweb.ClassRegistry',
        'Easyweb.view.TabMenu'
    ],
    ...
    initListeners: function() {
        ...
        this.el.on('click', function(event, el) {
            ...
            url = Easyweb.History.cleanUrl(url);
            this.removeTab(url);
    ...
    formatTabTexts: function(tab) {
        if (/#!?\/api\//.test(tab.href)) {
            ...
            tab.text = Easyweb.ClassRegistry.shortName(fullClsName);
    ...
    removeTab: function(url) {
        ...
        if (this.activeTab === url) {
            if (this.tabs.length === 0) {
                ...
                Easyweb.App.getController(this.getControllerName(url)).loadIndex();
            }
            else {
    ...
    createMenu: function() {
        var menu = new Easyweb.view.TabMenu({
            listeners: {
    ...
    saveTabs: function() {
        Easyweb.Settings.set('tabs', this.tabs);
    },
