 ...
 */
Ext.define('Easyweb.view.cls.Overview', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.classoverview',
    requires: [
        'Easyweb.view.cls.Toolbar',
        'Easyweb.view.examples.Inline',
        'Easyweb.view.comments.LargeExpander',
        'Easyweb.view.cls.MemberWrap',
        'Easyweb.view.comments.MemberWrap',
        'Easyweb.Syntax',
        'Easyweb.Settings',
        'Easyweb.Comments'
    ],
    ...
    load: function(docClass) {
        ...
        this.toolbar = Ext.create('Easyweb.view.cls.Toolbar', {
        ...
        this.filterMembers("", Easyweb.Settings.get("show"));
    ...
    initComments: function() {
        ...
        this.toolbar.setCommentCount(Easyweb.Comments.getCount(["class", this.docClass.name, ""]));

        // Insert class level comment container under class intro docs
        this.clsExpander = new Easyweb.view.comments.LargeExpander({
        ...
        Ext.Array.forEach(Ext.query('.member'), function(memberEl) {
            var wrap = new Easyweb.view.comments.MemberWrap({
                parent: this,
    ...
    initBasicMemberWrappers: function() {
        this.memberWrappers = {};
        Ext.Array.forEach(Ext.query('.member'), function(memberEl) {
            var wrap = new Easyweb.view.cls.MemberWrap({
                el: memberEl
            });
            this.memberWrappers[wrap.getMemberId()] = wrap;
        }, this);
    ...
    updateCommentCounts: function() {
        ...
        var clsCount = Easyweb.Comments.getCount(["class", this.docClass.name, ""]);
        ...
        Ext.Object.each(this.memberWrappers, function(name, wrap) {
            wrap.setCount(Easyweb.Comments.getCount(wrap.getTarget()));
        }, this);
    },
    ...
    filterMembers: function(search, show) {
        Easyweb.Settings.set("show", show);
