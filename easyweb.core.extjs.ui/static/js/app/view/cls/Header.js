 ...
 */
Ext.define('Easyweb.view.cls.Header', {
    ...
    initComponent: function() {
        this.tpl = Ext.create('Ext.XTemplate',
            ...
            '</h1>',
            '<tpl if="Easyweb.data.showPrintButton">',
            ...
            '</tpl>',
            {
                ...
                renderMetaTags: function(metaTags) {
                    return ' ' + Easyweb.view.Signature.render(metaTags, "long");
                }
            }
        );

        if (Easyweb.data.source) {
