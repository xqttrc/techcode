 ...
 */
Ext.define('Easyweb.view.cls.PackageLogic', {
    extend: 'Easyweb.view.cls.Logic',
    requires: "Easyweb.ClassRegistry",
    ...
    addClass: function(cls) {
        ...
        if (this.packages[cls.name]) {
            ...
            var parentName = Easyweb.ClassRegistry.packageName(cls.name);
    ...
    addPackage: function(name) {
        var parentName = Easyweb.ClassRegistry.packageName(name);
        var parent = this.packages[parentName] || this.addPackage(parentName);
    ...
    classNode: function(cls) {
      return {
        text: Easyweb.ClassRegistry.shortName(cls.name),
        url: "#!/api/"+cls.name,
        iconCls: cls.icon,
    ...
    packageNode: function(name) {
      return {
        text: Easyweb.ClassRegistry.shortName(name),
        iconCls: "icon-pkg",
        leaf: false,
        children: []
      };
