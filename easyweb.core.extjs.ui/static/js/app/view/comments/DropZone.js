 ...
 */
Ext.define("Easyweb.view.comments.DropZone", {
     ...
     * @template
     * @param {Easyweb.model.Comment} comment The comment that was dragged.
     * @param {Easyweb.model.Comment} parent The comment that it got dropped on.
     */
