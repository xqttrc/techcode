 ...
 */
Ext.define('Easyweb.view.comments.MemberWrap', {
    extend: 'Easyweb.view.cls.MemberWrap',
    requires: [
        "Easyweb.Comments",
    ...
    /**
     * @cfg {Easyweb.view.cls.Overview} parent
    ...
    constructor: function(cfg) {
        ...
        var count = Easyweb.Comments.getCount(this.getTarget());
        if (count > 0) {
    ...
    getExpander: function() {
        if (!this.expander) {
            ...
            this.expander = new Easyweb.view.comments.Expander({
                count: Easyweb.Comments.getCount(this.getTarget()),
    ...
    updateSignatureCommentCount: function(count) {
        ...
        if (count > 0) {
            if (titleComments) {
                ...
                var el = Ext.DomHelper.append(titleEl, Easyweb.Comments.counterHtml(count), true);
