 ...
 */
Ext.define('Easyweb.view.comments.Template', {
    ...
    statics: {
         ...
         * @return {Easyweb.view.comments.Template}
         */
        create: function(cfg) {
    ...
    avatar: function(emailHash) {
        ...
        return Easyweb.Comments.avatar(emailHash, this.isMod() && this.enableDragDrop ? "drag-handle" : "");
    },
    ...
    isMod: function() {
        return Easyweb.Auth.isModerator();
    },

    isAuthor: function(author) {
        return Easyweb.Auth.getUser().userName == author;
    },
