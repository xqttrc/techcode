 ...
 */
Ext.define('Easyweb.view.comments.Expander', {
    alias: "widget.commentsExpander",
    extend: 'Ext.Component',
    requires: [
        'Easyweb.Comments',
        'Easyweb.view.comments.TopLevelDropZone'
    ],
    uses: [
        'Easyweb.view.comments.ListWithForm'
    ],
    ...
    afterRender: function() {
        ...
        new Easyweb.view.comments.TopLevelDropZone(this.getEl().down(".side.toggleComments"), {
    ...
    loadComments: function() {
        this.list = new Easyweb.view.comments.ListWithForm({
            target: this.target,
    ...
    reload: function() {
        Easyweb.Comments.load(this.target, function(comments) {
