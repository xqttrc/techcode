 ...
 */
Ext.define('Easyweb.view.comments.Users', {
    alias: "widget.commentsUsers",
    extend: 'Ext.panel.Panel',
    componentCls: "comments-users",
    requires: [
        "Easyweb.Comments",
        "Easyweb.view.SimpleSelectBehavior",
        "Easyweb.view.comments.FilterField"
    ],
    ...
    initComponent: function() {
                ...
                tpl: [
                    ...
                    '<tpl for=".">',
                        '<li>',
                            ...
                            '{[Easyweb.Comments.avatar(values.emailHash)]}',
        ...
        new Easyweb.view.SimpleSelectBehavior(this.list, {
    ...
    fetchUsers: function(sortBy) {
        Easyweb.Comments.request("jsonp", {
            url: '/users',
            method: 'GET',
            params: {
                sortBy: sortBy
