 ...
 */
Ext.define('Easyweb.view.comments.FullList', {
    ...
    initCheckboxes: function() {
        var settings = Easyweb.Settings.get("comments");
        ...
        var Auth = Easyweb.App.getController("Auth");
    ...
    setHideReadVisibility: function() {
        var mod = Easyweb.Auth.isModerator();
    ...
    saveSetting: function(name, enabled) {
        ...
        Easyweb.Settings.set('comments', settings);
    },
