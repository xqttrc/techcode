 ...
 */
Ext.define('Easyweb.view.comments.List', {
    ...
    requires: [
        ...
        'Easyweb.Syntax',
        'Easyweb.Comments',
        'Easyweb.view.comments.Template',
        'Easyweb.view.comments.Form',
        'Easyweb.view.comments.TagEditor',
        'Easyweb.view.comments.RepliesExpander',
        'Easyweb.view.comments.DragZone',
        'Easyweb.view.comments.DropZone',
        'Easyweb.model.Comment',
        'Easyweb.Tip'
    ],
     ...
     * Used in Easyweb.view.comments.FullList.
     */
    ...
    initComponent: function() {
        ...
        this.tpl = Easyweb.view.comments.Template.create({
    ...
    renderExpanders: function(comments) {
        ...
        Ext.Array.forEach(comments, function(comment) {
            ...
            new Easyweb.view.comments.RepliesExpander({
    ...
    afterRender: function() {
        ...
        if (this.enableDragDrop) {
            new Easyweb.view.comments.DragZone(this);
            new Easyweb.view.comments.DropZone(this, {
    ...
    vote: function(el, comment, direction) {
        if (!Easyweb.Auth.isLoggedIn()) {
            Easyweb.Tip.show('Please login to vote on this comment', el);
            return;
        }
        if (comment.get("upVote") && direction === "up" || comment.get("downVote") && direction === "down") {
            Easyweb.Tip.show('You have already voted on this comment', el);
            return;
        }

        comment.vote(direction, {failure: function(msg) {
            Easyweb.Tip.show(msg, el);
        }});
    },
    ...
    edit: function(el, comment) {
        comment.loadContent(function(content) {
            ...
            new Easyweb.view.comments.Form({
                renderTo: contentEl,
    ...
    addTag: function(el, comment) {
        var editor = new Easyweb.view.comments.TagEditor();
