 ...
 *
 * Calling the #run method with bunch of Easyweb.model.Test records will
 ...
 */
Ext.define('Easyweb.view.tests.BatchRunner', {
    extend: 'Ext.container.Container',
    requires: ['Easyweb.view.examples.Inline'],
    ...
    initComponent: function() {
        this.addEvents(
             ...
             * @param {Easyweb.model.Test[]} status.remaining Remaining tests to be run.
             */
            "statuschange"
        );
     ...
     *
     * @param {Easyweb.model.Test[]} tests Array of tests to run
     */
    run: function(tests) {
    ...
    runNext: function(config) {
        ...
        var example = Ext.create('Easyweb.view.examples.Inline', {
