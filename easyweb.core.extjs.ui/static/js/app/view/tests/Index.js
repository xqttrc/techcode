 ...
 */
Ext.define('Easyweb.view.tests.Index', {
    extend: 'Ext.container.Container',
    requires: [
        'Easyweb.model.Test',
        'Easyweb.view.tests.BatchRunner'
    ],
    ...
    initComponent: function() {
        ...
        this.batchRunner = Ext.create('Easyweb.view.tests.BatchRunner', {
            height: 0,
            listeners: {
                start: this.disable,
                finish: this.enable,
     ...
     */
    getTab: function() {
        return Easyweb.data.tests ? {cls: 'tests', href: '#!/tests', tooltip: 'Tests', text: "Tests"} : false;
    },

    /**
     * Adds new example to full list of examples.
     * @param {Easyweb.model.Test} examples The DocTest model instance or config for it.
     */
