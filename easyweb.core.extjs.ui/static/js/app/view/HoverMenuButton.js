...
Ext.define('Easyweb.view.HoverMenuButton', {
    ...
    onDestroy: function() {
        if (this.menu) {
            ...
            Ext.Array.remove(Easyweb.view.HoverMenuButton.menus, this.menu);
        }
    ...
    renderMenu: function() {
        this.menu = Ext.create('Easyweb.view.HoverMenu', {
            store: this.store,
        ...
        Easyweb.view.HoverMenuButton.menus.push(this.menu);
    },

    deferHideMenu: function() {
        // when showing in progress, stop it
        clearTimeout(Easyweb.view.HoverMenuButton.showTimeout);
    ...
    deferShowMenu: function() {
        clearTimeout(Easyweb.view.HoverMenuButton.showTimeout);
        Easyweb.view.HoverMenuButton.showTimeout = Ext.Function.defer(function() {
            ...
            // hide other menus
            Ext.Array.forEach(Easyweb.view.HoverMenuButton.menus, function(menu) {
                if (menu !== this.menu) {
                    menu.hide();
                }
            }, this);
