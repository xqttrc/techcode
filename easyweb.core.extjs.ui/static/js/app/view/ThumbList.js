 ...
 */
Ext.define('Easyweb.view.ThumbList', {
    ...
    initComments: function() {
        this.getEl().select("dd").each(function(dd) {
            ...
            var count = Easyweb.Comments.getCount([this.commentType, name, ""]);
            if (count) {
                Ext.DomHelper.append(dd.down("p"), Easyweb.Comments.counterHtml(count));
            }
        }, this);
    },
