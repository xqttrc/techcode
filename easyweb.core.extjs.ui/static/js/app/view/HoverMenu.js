/**
 * Menu shown by {@link Easyweb.view.HoverMenuButton}.
 */
Ext.define('Easyweb.view.HoverMenu', {
    extend: 'Ext.view.View',
    requires: [
        'Easyweb.Comments',
        'Easyweb.view.Signature'
    ],
        ...
        this.tpl = new Ext.XTemplate(
            ...
            '</table>',
            {
                ...
                renderLink: function(values) {
                    var tags = Easyweb.view.Signature.render(values.meta);
                    var cnt = Easyweb.Comments.counterHtml(values.commentCount);
