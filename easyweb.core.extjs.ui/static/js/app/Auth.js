...
Ext.define('Easyweb.Auth', {
    ...
    init: function(callback, scope) {
        Ext.Ajax.request({
            url: Easyweb.data.commentsUrl + '/session',
    ...
    login: function(cfg) {
        Ext.Ajax.request({
            url: Easyweb.data.commentsUrl + '/login',
            method: 'POST',
            cors: true,
            params: {
    ...
    logout: function(callback, scope) {
        Ext.Ajax.request({
            url: Easyweb.data.commentsUrl + '/logout?sid=' + this.getSid(),
            method: 'POST',
            cors: true,
            callback: function() {
    ...
    getRegistrationUrl: function() {
        return Easyweb.data.commentsUrl + "/register";
    }
