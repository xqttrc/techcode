 ...
 * A comment model.
 */
Ext.define('Easyweb.model.Comment', {
    ...
    setDeleted: function(deleted) {
        this.request({
            ...
            success: function() {
                ...
                this.commit();
                Easyweb.Comments.changeCount(this.get("target"), deleted ? -1 : +1);
            },
            scope: this
        });
    },
     ...
     * @param {Easyweb.model.Comment} parent The parent comment
