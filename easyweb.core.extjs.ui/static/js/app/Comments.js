 ...
 */
Ext.define('Easyweb.Comments', {
    extend: 'Ext.util.Observable',
    singleton: true,
    requires: [
        "Easyweb.Auth",
        "Easyweb.CommentCounts",
        "Easyweb.CommentSubscriptions",
        "Ext.data.JsonP",
        "Ext.Ajax"
    ],
    ...
    init: function(callback, scope) {
        if (!(Easyweb.data.commentsUrl && Easyweb.data.commentsDomain && this.isBrowserSupported())) {
            callback.call(scope);
            return;
        }

        Easyweb.Auth.init(function(success) {
            if (success) {
                this.enabled = true;
                this.fetchCountsAndSubscriptions(function(counts, subscriptions) {
                    this.counts = new Easyweb.CommentCounts(counts);
                    this.subscriptions = new Easyweb.CommentSubscriptions(subscriptions);
                    callback.call(scope);
                }, this);
            }
            else {
    ...
    clearSubscriptions: function() {
        this.subscriptions = new Easyweb.CommentSubscriptions([]);
    },
    ...
    /**
     * @inheritdoc Easyweb.CommentCounts#get
     */
    ...
    /**
     * @inheritdoc Easyweb.CommentCounts#change
     */
    ...
    /**
     * @inheritdoc Easyweb.CommentSubscriptions#has
     */
    ...
    /**
     * @inheritdoc Easyweb.CommentCounts#getClassTotal
     */
    ...
    buildRequestUrl: function(url) {
        url = Easyweb.data.commentsUrl + "/" + Easyweb.data.commentsDomain + url;
        return url + (url.match(/\?/) ? '&' : '?') + 'sid=' + Easyweb.Auth.getSid();
    },
