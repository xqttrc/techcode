...
easyweb.core.base.Application = {
	/**
	 * Session object.
	 * 
	 * @type easyweb.core.base.Session
	 */
	session : null,
	/**
	 ...
	 * Login window object.
	 * 
	 * @type easyweb.core.base.LoginWindow
	 */
	loginWindow : null,
	/**
	...
	showFrameByName : function(bundle, name) {
		this.showFrame(name, {
			url : Easyweb.buildUiPath(bundle, name, false)
		});
	},
	/**
	 ...
	 */
	run : function() {
		this.session = easyweb.core.base.Session;
		if (this.useIframes) {
			this.navigator = easyweb.core.base.FrameNavigatorWithIframe;
		} else {
			this.navigator = easyweb.core.base.FrameNavigator;
		}
		this.navigator.maxOpenTabs = __MAX_OPEN_TABS__;

		if (this.loginWindow == null) {
			this.loginWindow = new easyweb.core.base.LoginWindow({});
		}
	...
	doLogout : function() {
		Ext.Ajax
				.request({
					method : "POST",
					scope : this,
					url : Easyweb.sessionAPI("json").logout,
					callback : function() {
						window.location.href = "/easyweb.core.web/security/session/login";
					}
				});
	...
	doLockSession : function() {
		Ext.Ajax.request({
			method : "POST",
			scope : this,
			url : Easyweb.sessionAPI("json").lock,
			timeout : 600000
		});
		this.loginWindow.applyState_LockSession();
		this.showLoginView();
	...
	changeCurrentTheme : function(t) {
		window.location.href = Easyweb.uiUrl + "/?theme=" + t
	},
	/**
	...
	changeCurrentLanguage : function(l) {
		window.location.href = Easyweb.uiUrl + "/?lang=" + l
	},
	/**
