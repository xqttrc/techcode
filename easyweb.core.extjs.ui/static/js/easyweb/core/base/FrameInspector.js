Ext.define("easyweb.core.base.FrameInspector", {
    extend: "Ext.Window",
    title: Easyweb.translate("appmenuitem", "frameInspector__lbl"),
    border: true,
    height: 300,
    width: 500,
    layout: 'fit',
    ...
    initComponent: function() {
        ...
        this.tpl = new Ext.XTemplate(
                ...
                '<tpl for="dc">',
                '<p style=" padding-bottom: 5px;">{#}. <i>Key:</i> {alias} <br> <i>Class:</i> {name} <br> <i>Data-source: </i> <a href="#" onclick="javascript:var w=window.open( Easyweb.dsAPI(\'{dsAlias}\',\'html\').info ,\'DataSourceInfo\',\'width=600,height=500,scrollbars=yes\');w.focus();" >{ds}</a> </p></tpl>',
