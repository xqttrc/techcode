Ext.define('easyweb.core.base.NavigationTree$Model', {
...
Ext.define("easyweb.core.base.NavigationTree", {
    ...
    initComponent: function(config) {
        ...
        this.store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                type: 'ajax',
                method: "POST",
                url: Easyweb.dsAPI("MenuItemRtLovDs", "json").read,
                actionMethods: {
                    read: 'POST'
                },
                reader: {
            ...
            listeners: {
                beforeload: {
                    ...
                    fn: function(store, operation, eOpts) {
                        ...
                        store.proxy.extraParams[Easyweb.requestParam.FILTER] = Ext.encode({
